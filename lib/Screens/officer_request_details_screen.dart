...
class OfficerRequestScreen extends StatefulWidget {
  const OfficerRequestScreen({super.key});

  @override
  State<OfficerRequestScreen> createState() => _OfficerRequestScreenState();
}

class _OfficerRequestScreenState extends State<OfficerRequestScreen> {
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Common.customsmallbutton4(context, "Deny", () {},
                              AppColors.white, AppColors.darkblue, 0.40, 0.07),
                          Common.customsmallbutton4(context, "Approve", () {},
                              AppColors.darkblue, AppColors.white, 0.40, 0.07)
                        ],
                      )
                    ])),
          );
